...
export function ProcessSection() {
  ...
  return (
    <section ref={elementRef} id="process" className="py-32 relative bg-dark-gray">
      <div className="container mx-auto px-6">
        ...
        <div className="relative">
          {/* Central Timeline */}
          <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-neon-cyan via-neon-cyan/50 to-transparent"></div>
