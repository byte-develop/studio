...
- ✓ Полностью переработан дизайн модальных окон (темная тема)
- ✓ Убраны все фиктивные данные из статистики
- ✓ Добавлена полная адаптивность для мобильных устройств
- ✓ Исправлены проблемы с навигацией на маленьких экранах
- ✓ Пояснение статуса системы (проверка базы данных и API)
